...
wagerController = {
    ...
    findAllWagersByEvent: async function (req, res) {
        let allWagersByEvent = await Wager.find({ parentIdEvent: req.query.parentIdEvent })
        return res.json(allWagersByEvent.length)
    },
